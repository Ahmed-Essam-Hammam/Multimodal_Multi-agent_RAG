"""
Response agent for generating final answers based on verified information.
"""
...
6. Never fabricate or hallucinate information not present in the retrieved data
...
- If no information found, suggest alternatives or acknowledge limitations"""
...
3. Verifying the quality of uploaded documents"""
    ...
    def _generate_unverified_response(
        ...
        """Generate response for unverified information."""
...
2. Clearly indicates the information is unverified
...
4. Acknowledges uncertainty""")
    ...
    def _generate_verified_response(
        ...
        """Generate response for verified information."""
        context = self._format_context(texts, images)
...
2. Uses specific information from the retrieved sources
3. Cites sources appropriately [Source: filename]
4. Integrates information from multiple sources if available
5. Mentions relevant images if present""")
        ]
